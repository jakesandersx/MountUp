...
function Basketball({ navigation }) {
    const article = [
        ...
        { title: "Example Article Title", sport: "Baseball", image: require("../images/baseball.png"), date: "" }
    ];
            ...
            ListHeaderComponent={
                <ImageBackground source={require("../images/msjLogo.png")} style={homeStyles.hero}>
                    <LinearGradient colors={["transparent", "#000"]} style={homeStyles.heroGradient}>
                        ...
                        <Text style={homeStyles.heroText}>Basketball</Text>
                    </LinearGradient>
                </ImageBackground>
            }
        />
